...
import com.example.filedownload.databinding.FragmentDetectingOtpDialogBinding
import com.example.filedownload.home.MainActivity
import com.example.loginviaotp.Utils
import com.example.loginviaotp.isNumeric
...
class DetectingOtpDialogFragment : DialogFragment() {
    ...
    fun initControl() {
        ...
        Utils.showToast(context!!,"OTP resend.")
        }
